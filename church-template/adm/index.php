		...
		<div class="bar-top show-for-large-up" style="height:65px;background:#142536;">	
			...
			<div class="small-12 large-10 columns" style="text-align:center; font-size:14px;">
				...
				foreach ($explodeP as $key => $value) {
			 	...
			 	?>
				<p style="float:right; margin-right:20px!important; font-size:14px; display:table;color:white;">
					Bem vindo <?php if($usuariosP){ ?><a href="?go=usuarios&edit=<?php echo $uasdas['id'] ?>"><b><?php echo ucwords($uasdas['nome']); ?> <i class="fa fa-cog"></i></b></a> <?php }else echo "<b>".ucwords($uasdas['nome'])."</b>";  ?>
				</p>
			</div>
		</div> 
