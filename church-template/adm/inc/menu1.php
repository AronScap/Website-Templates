			...
			<div class="small-12"> 
				...
				<!-- cadastros -->
					<!-- <ul class="accordion act" data-accordion >  	
						<li class="accordion-navigation" <?php if (isset($_GET['go']) && ($_GET['go'] == 'categorias' || $_GET['go'] == 'newsletter' || $_GET['go'] == 'empresa' || $_GET['go'] == 'parceiros')): ?> active <?php endif ?>>
						    <a href="#panel3aasd" <?php if (isset($_GET['go']) && ($_GET['go'] == 'categorias' || $_GET['go'] == 'newsletter' || $_GET['go'] == 'empresa' || $_GET['go'] == 'parceiros')){ ?> onclick="change2('setinha123')" <?php }else{ ?> onclick="change('setinha123')" <?php } ?>> 
						    	<i class="fa fa-pencil-square-o" style="color:#333;"></i>
						    	Cadastros
						    	<i id="setinha123" <?php if (isset($_GET['go']) && ($_GET['go'] == 'categorias' || $_GET['go'] == 'newsletter' || $_GET['go'] == 'empresa' || $_GET['go'] == 'parceiros')){ ?> class="fa fa-caret-down" teste="0" <?php }else{ ?> class="fa fa-caret-right" teste="1"<?php } ?> style="float:right;display:table; margin-top:5px;"></i>
							</a> 
						    <div id="panel3aasd" class="content <?php if (isset($_GET['go']) && ($_GET['go'] == 'categorias' || $_GET['go'] == 'newsletter' || $_GET['go'] == 'empresa' || $_GET['go'] == 'parceiros')): ?> active <?php endif ?>" style="padding-left:30px;">
						    	<ul> 
						    		<li>
						    			<a title="Categorias para o portfólio" style="color:#222;<?php if (isset($_GET['go']) && $_GET['go']=='categorias'): ?>font-weight:bold;color:#008CBA; <?php endif ?>font-size:14px; " href="?go=categorias">
						    				<i class="fa fa-cubes"  style="font-size:16px;<?php if (isset($_GET['go']) && $_GET['go']=='categorias'): ?>color:rgb(237,50,55);<?php endif ?>"></i>
						    				Categorias
						    			</a>
						    		</li> 
						    		<li>
						    			<a title="Contatos/E-mails do site" style="color:#222;<?php if (isset($_GET['go']) && $_GET['go']=='newsletter'): ?>font-weight:bold;color:#008CBA; <?php endif ?>font-size:14px; " href="?go=newsletter">
						    				<i class="fa fa-address-card"  style="font-size:16px;<?php if (isset($_GET['go']) && $_GET['go']=='newsletter'): ?>color:rgb(237,50,55);<?php endif ?>"></i>
						    				Contatos
						    			</a>
						    		</li>
						    		<li>
						    			<a style="color:#222;<?php if (isset($_GET['go']) && $_GET['go']=='parceiros'): ?>font-weight:bold;color:#008CBA; <?php endif ?>font-size:14px; " href="?go=parceiros">
						    				<i class="fa fa-users"  style="font-size:16px;<?php if (isset($_GET['go']) && $_GET['go']=='parceiros'): ?>color:rgb(237,50,55);<?php endif ?>"></i>
						    				Parceiros
						    			</a>
						    		</li>  
						    	</ul>
				...
				<!-- portfolio -->
					...
					<ul class="accordion act "  >  	
						<li class="accordion-navigation<?php if (isset($_GET['go']) && ($_GET['go'] == 'portfolio')): ?> active <?php endif ?>" >
						    <a href="?go=portfolio" title="" style="<?php if (isset($_GET['go']) && $_GET['go']=='portfolio'): ?>font-weight:bold;color:#008CBA; <?php endif ?>"> 
						    	<i class="fa fa-image" style="color:#333;<?php if (isset($_GET['go']) && $_GET['go']=='portfolio'): ?>font-weight:bold;color:rgb(237,50,55); <?php endif ?>"></i>
						    	Portfolio
							</a>
						</li>
					</ul>
